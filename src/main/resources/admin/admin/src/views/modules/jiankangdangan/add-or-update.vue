		...
		>
			<template >
				...
				<el-form-item class="select" v-if="type!='info'"  label="血型" prop="xuexing" >
					<el-select :disabled="ro.xuexing" v-model="ruleForm.xuexing" placeholder="请选择血型" >
						<el-option
				...
				<el-form-item v-else class="input" label="血型" prop="xuexing" >
			...
			<el-form-item class="textarea" v-if="type!='info'" label="住院记录" prop="zhuyuanjilu" >
				<el-input
					style="min-width: 200px; max-width: 600px;"
					type="textarea"
					:rows="8"
			...
			<el-form-item v-else-if="ruleForm.zhuyuanjilu" label="住院记录" prop="zhuyuanjilu" >
				<span class="text">{{ruleForm.zhuyuanjilu}}</span>
			</el-form-item>
