				...
				<el-table
					...
					<el-table-column
						...
						<template slot-scope="scope">
							<el-button
								type="text"
								:style='{"border":"1px solid #2990ff","cursor":"pointer","padding":"0 5px","margin":"0 5px 5px 0","color":"#2990ff","borderRadius":"4px","background":"#fff","width":"auto","fontSize":"14px","height":"32px"}'
								size="small"
