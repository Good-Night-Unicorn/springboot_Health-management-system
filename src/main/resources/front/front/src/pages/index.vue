	...
	<div class="main-containers">
		<div class="body-containers">
			<div class="top-container">
				<!-- info -->
				<div class="top_title">
					<span @click="goMenu('/index/home')">基于SpringBoot与Vue.js的健康管理系统</span>
				</div>
		...
		<el-dialog title="AI健康顾问" :visible.sync="chatFormVisible" width="60%" :before-close="chatClose">
		...
		async getSession() {
			await this.$http.get(`${localStorage.getItem('UserTableName')}/session`, {emulateJSON: true}).then(async res => {
				if (res.data.code == 0) {
					...
					if(localStorage.getItem('UserTableName')== 'jiankangyisheng') {
						localStorage.setItem('username', res.data.data.yishenggonghao);
					}
