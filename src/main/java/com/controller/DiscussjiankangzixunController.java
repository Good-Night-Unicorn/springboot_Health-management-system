...
public class DiscussjiankangzixunController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,DiscussjiankangzixunEntity discussjiankangzixun,
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,DiscussjiankangzixunEntity discussjiankangzixun, 
		HttpServletRequest request){
        //设置查询条件
        EntityWrapper<DiscussjiankangzixunEntity> ew = new EntityWrapper<DiscussjiankangzixunEntity>();
    ...
    public R info(@PathVariable("id") Long id){
        ...
        Map<String, String> deSens = new HashMap<>();
        //给需要脱敏的字段脱敏
        DeSensUtil.desensitize(discussjiankangzixun,deSens);
    ...
    public R save(@RequestBody DiscussjiankangzixunEntity discussjiankangzixun, HttpServletRequest request){
        ...
        return R.ok().put("data",discussjiankangzixun.getId());
    }
    ...
    public R security(@RequestParam String username){
        DiscussjiankangzixunEntity discussjiankangzixun = discussjiankangzixunService.selectOne(new EntityWrapper<DiscussjiankangzixunEntity>().eq("", username));
        return R.ok().put("data", discussjiankangzixun);
    }
    ...
    public R update(@RequestBody DiscussjiankangzixunEntity discussjiankangzixun, HttpServletRequest request){
        //ValidatorUtils.validateEntity(discussjiankangzixun);
        //全部更新
        discussjiankangzixunService.updateById(discussjiankangzixun);
        return R.ok();
    }
    ...
    public R autoSort(@RequestParam Map<String, Object> params,DiscussjiankangzixunEntity discussjiankangzixun, HttpServletRequest request,String pre){
        EntityWrapper<DiscussjiankangzixunEntity> ew = new EntityWrapper<DiscussjiankangzixunEntity>();
